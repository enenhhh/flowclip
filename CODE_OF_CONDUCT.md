...
Sensitive reports may be submitted privately through this repository's GitHub
Private Vulnerability Reporting form: open **Security**, then **Advisories**,
then **Report a vulnerability**, and prefix the report title with
`[Code of Conduct]`. Non-sensitive questions about community moderation may be
opened as a regular Issue. Do not publish another person's private information
in an Issue.
